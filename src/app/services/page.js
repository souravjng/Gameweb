...
const Services = () => {
  ...
  return (<>
    ...
    <a href='https://www.flipkart.com/sony-ps5-standard-dualsense-bundle-cfi-1208a01r-825gb-ssd-gb/p/itm73b71109455e7?pid=GMCGS45PYCYPQMDS&lid=LSTGMCGS45PYCYPQMDSKQQYE6&marketplace=FLIPKART&q=ps5&store=4rr%2Fx1m&srno=s_1_2&otracker=search&otracker1=search&fm=organic&iid=a248f9d8-9cd0-48c6-8f58-8853bed512da.GMCGS45PYCYPQMDS.SEARCH&ppt=hp&ppn=homepage&ssid=hpwyvvldfk0000001699358828004&qH=458a2eb0daa8654a' className={styles.btn1}>Click </a>
    <Image  className={styles.image2}  width={760} height={550}  src={xboximg} alt="xbox_img"/>
    <a href='https://www.flipkart.com/microsoft-xbox-series-x-1024-gb/p/itm5f4b119752568?pid=GMCFVPFCFDFGJHGG&lid=LSTGMCFVPFCFDFGJHGGFHTWV3&marketplace=FLIPKART&q=xbox&store=4rr&srno=s_1_2&otracker=search&otracker1=search&fm=organic&iid=665b9669-4ea0-484f-bf08-4ca90e73643a.GMCFVPFCFDFGJHGG.SEARCH&ppt=pp&ppn=pp&ssid=urco7dhrcw0000001699358872120&qH=3a3417f5f20a03a9' className={styles.btn2}> me</a>
    </div>
