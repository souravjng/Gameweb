...
const Home = () => {
  const data = [
    {title: 'Enter the Norse realm, A second chance',
      details: 'His vengeance against the Gods of Olympus years behind him, Kratos now lives as a man in the realm of Norse Gods and monsters. It is in this harsh, unforgiving world that he must fight to survive… And teach his son to do the same.',
      img: img4,},
    {title: 'A darker, more elemental world',
      details: 'Kratos is a father again. As mentor and protector to Atreus, a son determined to earn his respect, he is forced to deal with and control the rage that has long defined him while out in a very dangerous world with his son.',
      img: img2, },
    {title: 'Visceral physical combat',
      details: 'From the marble and columns of ornate Olympus to the gritty forests, mountains, and caves of Pre-Viking Norse lore, this is a distinctly new realm with its own pantheon of creatures, monsters, and gods.',
      img: img3, },
    {title: 'A new main weapon and new abilities',
      details: 'A new main weapon and new abilities retain the defining spirit of God of War while presenting a vision of violent conflict that forges new ground in the genre.',
      img: img1, },];
